public class Main {
    public static void main(String args[]) {
        ...
        System.out.println("-----> Mr. Miller is getting a new credit card!");
        CreditCard myCard = new CreditCard("Mr. Miller", "9254");
        ...
        System.out.println("-----> Mr. Miller wants to buy 5 bagels using his new credit card");
        ...
        System.out.println("-----> Bill time!  Mr. Miller pays $15 of his credit card balance");
        ...
        System.out.println("-----> Mr. Miller pays off his card in full");
